...
public class FirstPlugin extends ProgramPlugin {
    ...
    private static class MyProvider extends ComponentProvider implements ActionListener {
        ...
        private void builPopup(String namePopUp, String nameLabel, String nameButton) {
            ...
            popup.add(commentMetadataField);
            popup.add(commentMetadata);
            buttonAddMetadata.setBounds(280, 180, 115, 30);
            NameMetadataField.setBounds(160, 60, 405, 30);
            LabelNameMetadata.setBounds(60, 60, 100, 25);
            commentMetadataField.setBounds(160, 120, 405, 30);
            commentMetadata.setBounds(60, 120, 100, 25);
            popup.pack();
        ...
        private void metadataTable(String opCode, String architecture) {
            ...
            functionMetadata fm = new functionMetadata(opCode, architecture, null);
            String md5Opcode = calculMd5(opCode);
            String crc32opcode = calculCrc32(opCode);
            JSONObject json = myService.scanForSimilarFunction(md5Opcode, crc32opcode, fm);
            String matches = json.get("failed").toString();
            metadataList = new Object[metadataModel.size()][7];
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (object == loadFunctions) {
                ...
                String comment = new String(commentMetadataField.getText());
                try {
                    addFunctionMetadata(metadata, comment);
                } catch (Exception e) {
                ...
                String architecture = aList.get(selectedRow).architecture.toString();

                metadataTable(opCode, architecture);
        ...
        // FIXME  		  
        private void addFunctionMetadata(String nameMetadata, String comment) throws Exception {
            ...
            functionMetadata fm = new functionMetadata(rowFunction.opCode, rowFunction.architecture.toString(), nameMetadata, rowFunction.prototypefunction, comment, apis);
